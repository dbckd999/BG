 ...
 * 
 * import lombok.extern.log4j.Log4j; import study.projectBG.BG.model.MapDTO;
 ...
 * 
 * @Log4j public class TestadminRestroom {
 * 
 * @Autowired AdminRestroomService adminRestroomService;
 * 
 ...
 * //@Test
 * 
 * public void test() { MapDTO dto = new MapDTO(); dto.setCategory("dfdfd");
 * dto.setDb_update_date("2022-10-10"); dto.setRestroom_name("dfdf");
 * dto.setAddress_load("dfdfdf"); dto.setAddress_location("ddd");
 * dto.setIs_public_gender(false); dto.setC_man_closet(0);
 * dto.setC_man_urinal(null); dto.setC_man_disable_person_closet(null);
 * dto.setC_man_disable_person_urinal(null); dto.setC_man_child_closet(null);
 * dto.setC_man_child_urinal(null); dto.setC_woman_closet(null);
 * dto.setC_woman_disable_person_urinal(null);
 * dto.setC_woman_child_closet(null); dto.setManage_group_name(null);
 ...
 * 
 * 
 * @Test public void test2(int id) { id = 1983;
