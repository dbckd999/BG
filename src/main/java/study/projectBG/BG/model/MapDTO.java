...
public class MapDTO {
	...
	private String is_public_gender; // 남녀공용화장실여부
	...
	private String have_emergency_bell; // 비상벨설치여부: 위용위용
	private String emergency_bell_location; // 비상벨설치장소
	private String have_entrance_cctv; // 화장실입구CCTV설치유무
	private String have_diaper_switchboard; // 기저귀교환대유무
